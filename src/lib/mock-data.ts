export const materials = [
  ...
  { id: "toilet-roll", name: "Toilet Paper Roll", icon: "🧻", category: "paper" },
  { id: "tape", name: "Tape", icon: "🔲", category: "connectors" },
  { id: "markers", name: "Markers", icon: "🖊️", category: "art" },
  { id: "plastic-cup", name: "Plastic Cup", icon: "🥤", category: "containers" },
  { id: "bottle-caps", name: "Bottle Caps", icon: "⚙️", category: "recyclables" },
  { id: "string", name: "String", icon: "🧶", category: "connectors" },
  { id: "egg-carton", name: "Egg Carton", icon: "🥚", category: "paper" },
  { id: "foil", name: "Foil", icon: "✨", category: "paper" },
  { id: "glue", name: "Glue", icon: "🔧", category: "connectors" },
  { id: "scissors", name: "Scissors", icon: "✂️", category: "tools" },
  { id: "popsicle-sticks", name: "Popsicle Sticks", icon: "🪵", category: "connectors" },
  { id: "rubber-bands", name: "Rubber Bands", icon: "🔁", category: "connectors" },
  { id: "newspaper", name: "Newspaper", icon: "📰", category: "paper" },
  { id: "plastic-bottle", name: "Plastic Bottle", icon: "🍶", category: "containers" },
  { id: "paper-bag", name: "Paper Bag", icon: "🛍️", category: "paper" },
];
