...
const challenges: Challenge[] = [
  ...
  },
  {
    ...
    description: "Challenge yourself: pick just a few materials and see what you can build.",
    badge: "New",
...
function ChallengeCardContent({ challenge }: { challenge: Challenge }) {
  return (
    <>
      ...
      {challenges.map(challenge =>
        challenge.href ? (
          ...
          <div
            key={challenge.label}
            aria-disabled="true"
            className="flex items-center gap-4 bg-white rounded-3xl shadow-card p-4 opacity-60 cursor-default"
          >
            <ChallengeCardContent challenge={challenge} />
          </div>
        )
