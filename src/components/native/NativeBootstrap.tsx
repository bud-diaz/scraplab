...
// screen once this client bundle has hydrated (capacitor.config.ts sets
// launchAutoHide: false so it doesn't disappear before the remote page is
// actually ready), and refreshing plan state on foreground so a purchase or
// renewal that happened while backgrounded is reflected without a relaunch
